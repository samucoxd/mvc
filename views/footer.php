...
<footer class="sticky-footer bg-white">
  ...
  <script src="<?php echo constant('URL');?>public/js/demo/chart-pie-demo.js"></script>
    <!-- Page level plugins -->
    <script src="<?php echo constant('URL');?>public/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="<?php echo constant('URL');?>public/vendor/datatables/dataTables.bootstrap4.min.js"></script>
